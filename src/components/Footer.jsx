...
export const Footer = () => {
    return (
        <>
            ...
            <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b  bg-black text-white/70">
                ...
                <p className="mt-4 text-center">Copyright © 2025 <a href="#">Srinu</a>. All rights reserved.</p>
